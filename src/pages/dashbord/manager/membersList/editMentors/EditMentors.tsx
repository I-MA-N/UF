...
import MentorDataModal from "../modals/MentorDataModal";
   ...
   return (
      <Container>
         ...
         <Btn
            ...
            className="w-[300px]"
         />
         <ul className="w-64 max-h-[304px] divide-y divide-primary mt-0.5 mb-8 rounded-b-[18px] overflow-y-auto">
            {
               data?.map((mentorInfo: any) => (
                  ...
                  >
                     <div className="flex justify-between items-center px-1.5 flex-grow">
                        <p className="line-clamp-1 mx-auto">{mentorInfo.name}</p>
         ...
         <Link
            ...
            icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
               <path d="M0.55 3.66683C0.55 4.40915 0.590493 4.96813 0.6852 5.39428C0.778519 5.81417 0.917003 6.07064 1.08993 6.24357C1.26286 6.41649 1.51932 6.55498 1.93922 6.6483C2.36536 6.743 2.92434 6.7835 3.66667 6.7835C4.40899 6.7835 4.96797 6.743 5.39411 6.6483C5.81401 6.55498 6.07048 6.41649 6.2434 6.24357C6.41633 6.07064 6.55481 5.81417 6.64813 5.39428C6.74284 4.96813 6.78333 4.40915 6.78333 3.66683C6.78333 2.92451 6.74284 2.36553 6.64813 1.93938C6.55481 1.51948 6.41633 1.26302 6.2434 1.09009C6.07048 0.917166 5.81401 0.778682 5.39411 0.685363C4.96797 0.590656 4.40899 0.550163 3.66667 0.550163C2.92434 0.550163 2.36536 0.590656 1.93922 0.685363C1.51932 0.778682 1.26286 0.917166 1.08993 1.09009C0.917003 1.26302 0.778519 1.51948 0.6852 1.93938C0.590493 2.36553 0.55 2.92451 0.55 3.66683Z" stroke="#E4F4FD" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round" />
               <path d="M0.55 12.3333C0.55 13.0757 0.590493 13.6346 0.6852 14.0608C0.778519 14.4807 0.917003 14.7371 1.08993 14.9101C1.26286 15.083 1.51932 15.2215 1.93922 15.3148C2.36536 15.4095 2.92434 15.45 3.66667 15.45C4.40899 15.45 4.96797 15.4095 5.39411 15.3148C5.81401 15.2215 6.07048 15.083 6.2434 14.9101C6.41633 14.7371 6.55481 14.4807 6.64813 14.0608C6.74284 13.6346 6.78333 13.0757 6.78333 12.3333C6.78333 11.591 6.74284 11.032 6.64813 10.6059C6.55481 10.186 6.41633 9.92952 6.2434 9.7566C6.07048 9.58367 5.81401 9.44519 5.39411 9.35187C4.96797 9.25716 4.40899 9.21667 3.66667 9.21667C2.92434 9.21667 2.36536 9.25716 1.93922 9.35187C1.51932 9.44519 1.26286 9.58367 1.08993 9.7566C0.917003 9.92952 0.778519 10.186 0.6852 10.6059C0.590493 11.032 0.55 11.591 0.55 12.3333Z" stroke="#E4F4FD" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round" />
               <path d="M9.2165 3.66683C9.2165 4.40915 9.257 4.96813 9.3517 5.39428C9.44502 5.81417 9.58351 6.07064 9.75643 6.24357C9.92936 6.41649 10.1858 6.55498 10.6057 6.6483C11.0319 6.743 11.5908 6.7835 12.3332 6.7835C13.0755 6.7835 13.6345 6.743 14.0606 6.6483C14.4805 6.55498 14.737 6.41649 14.9099 6.24357C15.0828 6.07064 15.2213 5.81417 15.3146 5.39428C15.4093 4.96813 15.4498 4.40915 15.4498 3.66683C15.4498 2.92451 15.4093 2.36553 15.3146 1.93938C15.2213 1.51948 15.0828 1.26302 14.9099 1.09009C14.737 0.917166 14.4805 0.778682 14.0606 0.685363C13.6345 0.590656 13.0755 0.550163 12.3332 0.550163C11.5908 0.550163 11.0319 0.590656 10.6057 0.685363C10.1858 0.778682 9.92936 0.917166 9.75643 1.09009C9.58351 1.26302 9.44502 1.51948 9.3517 1.93938C9.257 2.36553 9.2165 2.92451 9.2165 3.66683Z" stroke="#E4F4FD" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round" />
               <path d="M9.2165 12.3333C9.2165 13.0757 9.257 13.6346 9.3517 14.0608C9.44502 14.4807 9.58351 14.7371 9.75643 14.9101C9.92936 15.083 10.1858 15.2215 10.6057 15.3148C11.0319 15.4095 11.5908 15.45 12.3332 15.45C13.0755 15.45 13.6345 15.4095 14.0606 15.3148C14.4805 15.2215 14.737 15.083 14.9099 14.9101C15.0828 14.7371 15.2213 14.4807 15.3146 14.0608C15.4093 13.6346 15.4498 13.0757 15.4498 12.3333C15.4498 11.591 15.4093 11.032 15.3146 10.6059C15.2213 10.186 15.0828 9.92952 14.9099 9.7566C14.737 9.58367 14.4805 9.44519 14.0606 9.35187C13.6345 9.25716 13.0755 9.21667 12.3332 9.21667C11.5908 9.21667 11.0319 9.25716 10.6057 9.35187C10.1858 9.44519 9.92936 9.58367 9.75643 9.7566C9.58351 9.92952 9.44502 10.186 9.3517 10.6059C9.257 11.032 9.2165 11.591 9.2165 12.3333Z" stroke="#E4F4FD" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round" />
            </svg>}
            className="w-[300px]"
            url="/manager/memberslist/editmentors/addmentor"
         />
