...
function ChangeDataModal({ setChangeModal }: ChangeDataModalProps) {
   ...
   return (
      <div className="modal">
         <button onClick={() => setChangeModal(false)} className="flex gap-0.5 items-center mb-4.5 bg-primary text-yellow py-2 px-4 rounded-[32px]">
         ...
         <form onSubmit={handleSubmit(submitHandler)} className="w-[298px] xs:w-80 bg-white text-primary rounded-[32px] p-12">
