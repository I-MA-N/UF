                  ...
                  data.map((problem: any, index: number) => (
                     <tr key={index} className={`${(index + 1) % 2 === 0 && 'bg-white text-primary'}`}>
                        ...
                        <td className="w-[60px] lg:w-[80px] bg-[#fff]">
                           <img src={`/src/pages/dashbord/common/reportsJsx/reportsImages/problems/${problem.title}1.png`} className="w-full" alt="report-img" />
                        </td>
                        <td className="w-[60px] lg:w-[80px] bg-[#fff]">
                           <img src={`/src/pages/dashbord/common/reportsJsx/reportsImages/problems/${problem.title}2.png`} className="w-full" alt="report-img" />
                        </td>
                     </tr>
                  ))
               }
