import img from "/images/reportsImages/calorieAmount/index.png"
import calorieImg1 from "/images/reportsImages/calorieAmount/calorieImg1.png"
import calorieImg2 from "/images/reportsImages/calorieAmount/calorieImg2.png"
import { colarieAmountType } from "./calorieAmountData";

function calorieAmountJsx(data: colarieAmountType) {
   return (
      <>
         <h2 className="mb-2 text-center text-sm lg:text-lg">میزان کالری روزانه</h2>
         ...
         <h2 className="mb-2 mt-8 text-center text-sm lg:text-lg">میزان کالری و درشت مغذی پیشنهادی</h2>
         <table className="w-full text-center border border-white" cellPadding="6px">
            <thead>
               <tr>
                  <th>وعده ها</th>
