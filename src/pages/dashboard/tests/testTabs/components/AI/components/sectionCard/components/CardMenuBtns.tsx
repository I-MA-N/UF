   ...
   return (
      <>
         <button
            ...
            className={`absolute top-4 right-4 ${showMenu ? "opacity-100 z-20" : "opacity-0 -z-10"} text-primary`}
         >
         ...
         <button
            ...
            className={`absolute top-4 right-4 ${!showMenu ? "opacity-100 z-20" : "opacity-0 -z-10"}`}
         >
