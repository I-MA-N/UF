...
function CameraModeBtn({ isDisabled, setFacingMode }: CameraModeBtnProps) {
   return (
      <button
         ...
         className={`${isDisabled ? "bg-gray text-primary border-gray" :"bg-primary text-white border-primary"} size-11 border-2 rounded-full flex items-center justify-center transition-transform duration-200`}
      >
