...
function CameraModeBtn({ isDisabled, setFacingMode }: CameraModeBtnProps) {
   return (
      <button
         ...
         className={`${isDisabled ? "bg-gray text-primary" :"bg-primary text-white"} size-11 border-2 rounded-full flex items-center justify-center transition-transform duration-200`}
      >
