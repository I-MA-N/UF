...
function AddImageBtn({ sectionName, setIsAIMethod }: AddImageBtnProps) {
   ...
   return (
      <button
         type="button"
         className="px-4 lg:px-6 h-8 lg:h-10 mx-auto my-4 flex items-center gap-2 bg-white text-primary text-xs lg:text-sm rounded-[32px]"
         onClick={() => {
            setNameFromManualTab(sectionName);
            setIsAIMethod(true);
         }}
      >
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="none" className="size-4 lg:size-5">
