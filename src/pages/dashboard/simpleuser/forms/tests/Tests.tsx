...
function Tests({ testsArr, initialFormData }: TestsProps) {
   ...
   const { mutate, data, isPending } = PFormData(userData.username);
   ...
   return (
      <>
         <Container withTitle={false}>
            ...
            >
               ...
               <BottomBtns
                  getValues={getValues}
                  page={page}
                  formData={formData} formname={searchParams.get('formName')!}
                  mutate={mutate}
                  testsArr={testsArr}
                  setValue={setValue}
                  setShowExitModal={setShowExitModal}
         ...
         {showExitModal && <ExitModal setShowModal={setShowExitModal} linkTo="/simpleuser/dashboard/forms/" />}
