...
function ChangePassModal({ setPassModal }: ChangePassModalProps) {
   ...
   return (
      <div className="modal">
         <button onClick={() => setPassModal(false)} className="flex gap-0.5 items-center mb-4.5 bg-primary text-yellow lg:text-lg py-2 px-4 lg:px-5 rounded-[32px]">
         ...
         <form onSubmit={handleSubmit(submitHandler)} className="w-[298px] xs:w-80 lg:w-[424px] flex flex-col items-center gap-6 lg:gap-8 bg-white text-primary rounded-[32px] py-6 lg:py-8">
            {
               data?.access === 'false' &&
            ...
            <div className="space-y-4 text-xs lg:text-base w-36 lg:w-60">
               <div className="flex flex-col">
                  ...
                  <input
                     ...
                     id="oldpassword"
                     dir="ltr"
                     className="bg-transparent outline-none border-b border-b-[#000] my-1"
