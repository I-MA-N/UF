...
function UserListElem({ user, setState, setStateValue }: UserListElemProps) {
   return (
      <li
         key={user.username}
      ...
      >
         ...
         <div className="flex justify-center items-center gap-1.5 px-2.5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 12" fill="none" className={`w-4 lg:w-5 ${user.age && user.name && user.phone && 'text-secondary'}`}>
