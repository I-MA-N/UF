            ...
            mentors.length > 0 ?
               <Btn
                  ...
                  icon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="21" viewBox="0 0 24 21" fill="none">
                     ...
                     <path d="M16.3333 7C17.9333 7 19 8.33333 19 9.66667C19 11 17.9333 12.3333 16.3333 12.3333" stroke="#E4F4FD" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round" />
                     <path d="M19.0887 18.9999C21.5776 18.9999 22.9998 18.6666 22.9998 16.6666C22.9998 14.6666 21.5776 14.3333 17.6665 14.3333" stroke="#E4F4FD" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>}
                  className="w-[300px]"
               />
               :
               <div className="text-center text-sm mb-10">
                  ...
                  <span>با استفاده از دکمه زیر مربی جدیدی اضافه کنید.</span>
               </div>
         }
      </>
   );
