...
function AddMentor() {
   ...
   const submitHandler = (data: any) => {
      ...
      navigate('/manager/dashboard/memberslist/editmentors/addmentor2')
   }
         ...
         <form onSubmit={handleSubmit(submitHandler)} className="w-64 lg:w-80">
            ...
            <div className="flex gap-4 items-center mt-12">
               <Btn
                  ...
                  className="pr-3"
               />
               <PrevBtn type="button" onClick={() => navigate("/manager/dashboard/memberslist/editmentors", { replace: true })} />
            </div>
         </form>
      </Container>
   )
