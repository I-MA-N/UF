...
function GenderInput({ register, setValue, errors, defaultValue }: GenderInputPropsType) {
   ...
   return (
      <div className="mt-auto w-full">
         <p className="text-[10px] text-yellow mb-2">
