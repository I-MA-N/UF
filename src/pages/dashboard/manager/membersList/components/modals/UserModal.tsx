...
function UserModal({ userData, setUserData, mentorSelected }: UserModalPropsType) {
   ...
   return (
      <>
         <div className="modal">
            <button onClick={() => setUserData(null)} className="flex gap-0.5 items-center mb-4.5 bg-primary text-yellow lg:text-lg py-2 px-4 lg:px-5 rounded-[32px]">
            ...
            <div className="w-[298px] xs:w-80 lg:w-[424px] p-12 bg-white text-primary rounded-[32px]">
               <div className="flex gap-3.5 items-center border-b-2 border-primary pb-4 lg:pb-6 relative">
               ...
               <div className="flex items-center justify-between pt-6 lg:pt-8 text-[10px] lg:text-sm">
                  {
                     isPending ? 'در حال دریافت...' : data?.is_active ?
                        ...
                        >
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 18" fill="none" className="w-4.5 lg:w-5">
                        ...
                        >
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 18" fill="none" className="w-4.5 lg:w-5">
                  ...
                  <button
                     className="flex lg:flex-row-reverse items-center gap-2 text-red text-[10px] lg:text-sm"
                     onClick={() => setAction('delete')}
                  >
                     حذف کردن
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 18" fill="none" className="w-4 lg:w-4.5">
               ...
               <p className="text-[10px] lg:text-sm font-Estedad-ExtraLight mt-6 lg:mt-8 text-center">
                  تاریخ ایجاد کاربر:
