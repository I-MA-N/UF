   ...
   const resultArr = [
      {
         ...
         shortName: 'اسکات...',
         value: 0,
         src: '/images/FMS/squatting.png',
      },
      {
         name: 'عبور از مانع',
         shortName: 'عبور از...',
         value: 0,
         src: '/images/FMS/stepping.png',
      },
      {
         name: 'لانچ خطی',
         shortName: 'لانچ خطی',
         value: 0,
         src: '/images/FMS/lunging.png',
      },
      {
         name: 'تحرک پذیری شانه ها',
         shortName: 'تحرک پذیری...',
         value: 0,
         src: '/images/FMS/reaching.png',
      },
      {
         name: 'بالا آوردن فعال پا',
         shortName: 'بالا...',
         value: 0,
         src: '/images/FMS/leg-raising.png',
      },
      {
         name: 'شنای سوئدی',
         shortName: 'شنای...',
         value: 0,
         src: '/images/FMS/push-up.png',
      },
      {
         name: 'ثبات چرخشی',
         shortName: 'ثبات چرخشی',
         value: 0,
         src: '/images/FMS/rotary-stability.png',
      },
   ]
