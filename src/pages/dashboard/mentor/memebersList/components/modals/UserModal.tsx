...
function UserModal({ data, orgName }: UserModalProps) {
   ...
   return (
      <>
            ...
            <div className='flex items-center justify-center gap-4 my-6'>
               {
                  ...
                  <>
                     <Link
                        ...
                        url={`/mentor/dashboard/members/${orgName}/${data.username}`}
                     />
                     <Btn
                        text='ویرایش'
                        type='button'
         ...
         {
            showChangeModal &&
            <UserChangeModal userData={data} setShowChangeModal={setShowChangeModal} />
         }
      </>
   );
};
