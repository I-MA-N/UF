...
function Status2({ username, orgName }: Status2Props) {
   ...
   return (
      <>
         <p className="text-xs mx-auto text-center text-yellow">
            نام کاربری در سازمان وجود ندارد! می توانید کاربر جدیدی اضافه کنید.
         </p>
         {
            isError &&
            <p className="text-xs text-center text-red min-h-4 mt-4">
               مشکلی در اضافه کردن کاربر به وجود آمده!
            </p>
         }
         <form onSubmit={handleSubmit(submitHandler)} className="mt-4">
            ...
            <div className="flex gap-4 items-center mt-12">
               <Btn
                  ...
                  type="submit"
                  icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 14" fill="none" className="w-5">
